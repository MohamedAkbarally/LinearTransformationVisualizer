...
export default function VectorItem({x,y,z,deleteVector,updateVector,index, disabled}) {
    return (
        <div style={{marginTop:4, marginBottom: 8}}>
            <Divider style={{backgroundColor: COLOR_LIST[index], borderRadius: 2 ,height: 4, filter: "saturate(40%)"}}/>
...
/>
     ...
     disabled={disabled}
     InputProps={{
 endAdornment: <InputAdornment style={{color: COLOR_LIST[index]}} position="end">j</InputAdornment>,
}} variant="outlined" 
/>
     </Box>
     <Box p={1} >
